...
func canonicalServer() []frameCase {
	...
	return []frameCase{
		...
		{"enter", json.RawMessage(`{"type":"enter","id":9,"x":2048,"y":2048,"color":255,"name":"Zoë","character":"pigeon-man-pro"}`),
			enc(EncodeEnter(9, 2048, 2048, 0x0000FF, "Zoë", "pigeon-man-pro"))},

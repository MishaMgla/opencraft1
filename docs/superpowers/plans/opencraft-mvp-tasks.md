...
### [ ] T02 — Server scaffold + static page
- **Deps:** T01
...
### [ ] T03 — Record toolchain in AGENT_RULES
- **Deps:** T01
...
### [ ] T05 — Spatial grid / area-of-interest (Go)
- **Deps:** T01
...
### [ ] T07 — WebSocket dependency + connection handler (Go)
- **Deps:** T04, T06
...
### [ ] T08 — Wire sim + server in main (Go)
- **Deps:** T02, T07
...
### [ ] T09 — Isometric projection (client, pure)
- **Deps:** T01
...
### [ ] T10 — Binary wire codec mirror (client, pure)
- **Deps:** T01
...
### [ ] T12 — Input → local movement (client)
- **Deps:** T01
...
### [ ] T14 — Orchestration entry + client shell (client)
- **Deps:** T11, T12, T13
...
### [ ] T15 — End-to-end multiplayer verification
- **Deps:** T08, T14
...
### [ ] T18 — Register leaf docs in project-map + AGENT_RULES
- **Deps:** T16, T17
